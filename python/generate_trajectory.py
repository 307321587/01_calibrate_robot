...
def generate_trajectory():
    ...
    # ================设定空间轨迹参数================
    x_stride, y_stride, z_stride = 0.1, 0.1, 0.05
    x_min, x_max, y_min, y_max, z_min, z_max = -0.35, 0.3, -0.65, -0.4, 0.4, 0.6
    ...
    rx1, ry1, rz1 = -180,0,0
    rx2, ry2, rz2 = -179.344,15.245,-20.02
    rx3, ry3, rz3 = -178.95,-16.78,20.09
    rx4, ry4, rz4 = 164.75,-10.32,-1.91
    rx5, ry5, rz5 = -165.81,16.09,-4.99
    rx6, ry6, rz6 = -178.73,-21.52,-5.95
    rx7, ry7, rz7 = -178.95,20.69,-5.12
